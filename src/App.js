...
export default function App() {
    return _jsxs("div", { className: "w-full max-w-7xl mx-auto my-20 p-5 md:p-24", children: [_jsx("div", { className: "text-center text-2xl font-bold mb-10", children: "Nexo Markdown Editor" }), _jsx(Editor, { defaultValue: DEFAULT_MARKDOWN, onChange: (value) => {
                    ...
                    return _jsx(ReactMarkdown, { remarkPlugins: [
                            remarkGfm,
                            remarkDirective,
                            remarkCallout,
                            slugifyHeading,
                            remarkEmbed,
                            // remarkRehype,
                        ], className: "prose dark:prose-invert max-w-full", children: html });
                } })] });
}
