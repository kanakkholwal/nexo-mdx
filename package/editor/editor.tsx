import ToolBar from '@nexo-mdx/components/ToolBar';
import { Textarea } from '@nexo-mdx/components/ui/textarea';
import DividerPlugin from '@nexo-mdx/editor/plugins/divider';
import Emitter, { globalEmitter } from '@nexo-mdx/editor/share/emitter';
import { EditorConfig, EditorEvent, initialSelection, KeyboardEventListener, Selection } from '@nexo-mdx/editor/share/var';
import getDecorated from '@nexo-mdx/editor/utils/decorate';
import mergeConfig from '@nexo-mdx/editor/utils/mergeConfig';
import { getLineAndCol, isKeyMatch } from '@nexo-mdx/editor/utils/tool';
...
import { cssVariables, twClasses } from '@nexo-mdx/tailwind-classes';
  ...
  override render() {
    ...
    return (
      <div id={`${this.props.id || "nexo-mdx"}-wrapper`} ref={this.nodeMdPreviewWrapper}
        ...
        className={cn(twClasses.base.wrapper, this.props.className)}
        style={{
          ...cssVariables,
          ...this.props.style
        }}
        ...
        <div>
          {view === "edit" ? <div className={cn(twClasses.base.editor_container)} aria-label='editor-container'>
            <Textarea
              {...props}
              ...
              value={mdText}
              className={cn(twClasses.base.editor, this.config.textareaClassName)}
              wrap="hard"
            ...
            <div className={cn(twClasses.base.preview, "nexo-mdx-preview")} id={"nexo-mdx-preview"} aria-label='preview-container'>
              {renderHtml(mdText)}
            </div>
            : null
          }
